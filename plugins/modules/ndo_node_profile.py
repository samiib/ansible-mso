...
options:
  template:
    ...
    - This parameter of O(template_id) is required.
    type: str
  template_id:
    description:
    - The ID of the template.
    - The template must be a Fabric Resource Policy template.
    - This parameter of O(template) is required.
    type: str
  name:
    description:
...
def set_node_setting_relation(mso, mso_dict):
    ...
    if node_setting_uuid:
        node_setting_obj = get_template_object_by_uuid(mso, "nodePolicyGroup", node_setting_uuid)
